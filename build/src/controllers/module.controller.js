...
const getModuleByCourse = (0, HandleCatchAsync_1.default)(async (req, res) => {
    const modules = await module_service_1.default.getModuleByCourseService(req.params.id);
    (0, SendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
        message: 'Modules fetched successfully',
...
const updateModule = (0, HandleCatchAsync_1.default)(async (req, res) => {
    const module = await module_service_1.default.updateModuleService(req.params.id, req.body);
    (0, SendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
