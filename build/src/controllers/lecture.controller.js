...
const lecture_service_1 = __importDefault(
  require('../services/lecture.service'),
)
const createLecture = (0, HandleCatchAsync_1.default)(async (req, res) => {
  const lectureData = req.body
  const lecture =
    await lecture_service_1.default.createLectureService(lectureData)
...
const getLecturesByModule = (0, HandleCatchAsync_1.default)(
  async (req, res) => {
    ...
    const lectures =
      await lecture_service_1.default.getLecturesByModuleService(moduleId)
    ;(0, SendResponse_1.default)(res, {
      success: true,
      statusCode: 200,
      message: 'Lectures fetched successfully',
...
const updateLecture = (0, HandleCatchAsync_1.default)(async (req, res) => {
  ...
  const lecture = await lecture_service_1.default.updateLectureService(
    id,
    updateData,
  )
  ;(0, SendResponse_1.default)(res, {
