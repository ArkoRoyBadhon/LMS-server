...
const createEnrollment = (0, HandleCatchAsync_1.default)(async (req, res) => {
    ...
    const { _id } = req.user;
    const enrollment = await enrollment_service_1.default.createEnrollmentService(_id, course, status);
...
const getAllEnrollments = (0, HandleCatchAsync_1.default)(async (req, res) => {
    const enrollments = await enrollment_service_1.default.getAllEnrollmentsService();
    (0, SendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
...
const getEnrollmentById = (0, HandleCatchAsync_1.default)(async (req, res) => {
    ...
    const enrollment = await enrollment_service_1.default.getEnrollmentByIdService(id);
    (0, SendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
...
const getEnrollmentByIdForUser = (0, HandleCatchAsync_1.default)(async (req, res) => {
    ...
    const enrollment = await enrollment_service_1.default.getEnrollmentByIdForUserService(id, _id, search);
    (0, SendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
        message: 'Enrollment fetched successfully',
...
const getEnrollmentByUser = (0, HandleCatchAsync_1.default)(async (req, res) => {
    const { _id } = req.user;
    const enrollment = await enrollment_service_1.default.getEnrollmentByUserService(_id);
    (0, SendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
        message: 'Enrollment fetched successfully',
...
const updateEnrollment = (0, HandleCatchAsync_1.default)(async (req, res) => {
    ...
    const enrollment = await enrollment_service_1.default.updateEnrollmentService(id, req.body.status);
    (0, SendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
