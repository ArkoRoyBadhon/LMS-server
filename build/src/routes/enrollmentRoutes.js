...
router.post('/create', authMiddleware_1.default.isAuthenticated, authMiddleware_1.default.roleChecker(['USER']), (0, zodvalidator_1.validSchema)(enrollment_zod_1.enrollmentValidationSchema), enrollment_controller_1.default.createEnrollment);
