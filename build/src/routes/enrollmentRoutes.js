...
router.patch('/update/:id', authMiddleware_1.default.isAuthenticated, authMiddleware_1.default.roleChecker(['ADMIN']), enrollment_controller_1.default.updateEnrollment);
